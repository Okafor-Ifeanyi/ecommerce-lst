        ...
        <header>
                    ...
                    <div className={styles.ScrollHeader2}>
                        ...
                        <div className={styles.ScrollHeader2FollowUs}>
                            ...
                            <div className={styles.ScrollHeader2FollowUsIcons}>
                                <InstagramIcon className={styles.ScrollHeaderSocials} />
                                <YouTubeIcon className={styles.ScrollHeaderSocials}/>
                                <FacebookIcon className={styles.ScrollHeaderSocials}/>
                                <TwitterIcon className={styles.ScrollHeaderSocials}/>
                            </div>
                        </div>
                    </div>
                </nav>
            ...
            <nav className={styles.Header}>
                ...
                <div className={styles.HeaderUL}>
                    ...
                    <main>
                        <a href="#"> <PersonIcon /> <span>Login / Register</span></a>
